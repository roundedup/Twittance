...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    // min : float
    // min value
    min: kvLookup('min', config, dataset, 0, ""),

    // max : float
    // max value
    max: kvLookup('max', config, dataset, 100, ""),
    ...
    gaugeColor: kvLookup('gaugeColor', config, dataset, "#0084b4"),
    ...
    levelColors: kvLookup('levelColors', config, dataset, ["#C12E0E", "#C12E0E","#C12E0E"], 'array', ','),
